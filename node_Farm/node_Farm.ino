...
const char* WIFI_PASSWORD = "minh0919";

// MQTT: ID, server IP, port, username and password
const char* MQTT_CLIENT_ID = "sensor_farm";
const char* MQTT_SERVER_IP = "192.168.1.42";
const uint16_t MQTT_SERVER_PORT = 1883;
const char* MQTT_USER = "farmstay";
const char* MQTT_PASSWORD = "1234";

// MQTT: topic
const char* MQTT_SENSOR_TOPIC = "sensor/moisture";
const char* MQTT_SENSOR_TOPIC2 = "sensor/humi";
const char* MQTT_SENSOR_TOPIC3 = "sensor/temp";

const int sensor_pin = A0;
unsigned long lastSensorTime = 0;
const unsigned long sensorInterval = 5000; // Send sensor data every 10 seconds
